...
const AllTeamMembers = () => {
  const teamMembers = [
    ...
    { id: 10, name: 'Vanessa Magana', position: 'Secretary & Team Manager', email: 'magana.v@northeastern.edu', image: Vanessa },
    { id: 5, name: 'Vaibhav Patil', position: 'Project Manager', email: 'patil.vai@northeastern.edu', image: Vaibhav },
    { id: 4, name: 'Yash Trivedi', position: 'Technical Project Manager', email: 'trivedi.y@northeastern.edu', image: Yash },
    ...
    { id: 9, name: 'Ayush Patel', position: 'Social Media Manager', email: 'patel.ayushh@northeastern.edu', image: Ayush },
    { id: 11, name: 'Rishil Patel', position: 'Social Media Team', email: 'patel.rishilv@northeastern.edu', image: Rishil }, 
