...
const AllTeamMembers = () => {
  const teamMembers = [
    ...
    { id: 10, name: 'Vanessa Magana', position: 'Project Manager Head', email: 'magana.v@northeastern.edu', image: Vanessa },
    { id: 5, name: 'Vaibhav Patil', position: 'Project Manager Head', email: 'patil.vai@northeastern.edu', image: Vaibhav },
    { id: 4, name: 'Yash Trivedi', position: 'Technical Project Manager Head', email: 'trivedi.y@northeastern.edu', image: Yash },
